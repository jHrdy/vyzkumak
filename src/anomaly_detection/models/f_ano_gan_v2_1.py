...
class Generator2(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.ConvTranspose1d(in_channels=64, out_channels=32, kernel_size=2, stride=2)
        self.bn1 = nn.BatchNorm1d(32)
        
        self.conv2 = nn.ConvTranspose1d(in_channels=32, out_channels=16, kernel_size=2, stride=2, padding=1)
        self.bn2 = nn.BatchNorm1d(16)
        
        self.conv3 = nn.ConvTranspose1d(in_channels=16, out_channels=4, kernel_size=4, stride=1, padding=1)
        self.bn3 = nn.BatchNorm1d(4)
...
class Encoder2(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(in_channels=1, out_channels=4, kernel_size=4, stride=2, padding=1)
        self.bn1 = nn.BatchNorm1d(4)
        self.conv2 = nn.Conv1d(in_channels=4, out_channels=16, kernel_size=4, stride=2, padding=1)
        self.bn2 = nn.BatchNorm1d(16)
        self.conv3 = nn.Conv1d(in_channels=16, out_channels=32, kernel_size=2, stride=1, padding=1)
        self.bn3 = nn.BatchNorm1d(32)
        self.conv4 = nn.Conv1d(in_channels=32, out_channels=64, kernel_size=2, stride=1)
